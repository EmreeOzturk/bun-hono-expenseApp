...
var Hono = class extends defineDynamicClass() {
  ...
  fetch = (request3, Env, executionCtx) => {
...
// server/routes/expenseRouter.ts
var fakeExpenses = [
  {
    id: 1,
    title: "Rent",
...
var createPostSchema = expenseSchema.omit({ id: true });
var expensesRouter = new Hono2().get("/", (c) => {
...
var expenseRouter_default = expensesRouter;

// server/app.ts
var App = new Hono2;
App.use("*", logger());
var apiRoutes = App.basePath("/api").route("/expenses", expenseRouter_default);
App.get("*", serveStatic2({ root: "./client/dist" }));
App.get("*", serveStatic2({ path: "./client/dist/index.html" }));
var app_default = App;
